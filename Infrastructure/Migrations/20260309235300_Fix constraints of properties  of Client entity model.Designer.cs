...
namespace DomainData.Migrations
{
    ...
    [Migration("20260309235300_Fix constraints of properties  of Client entity model")]
    partial class FixconstraintsofpropertiesofCliententitymodel
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DomainData.Models.Client", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("DomainData.Models.DifficultyLevel", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasIndex(new[] { "Difficulty" }, "IX_Difficulty_Level");

                    b.ToTable("Difficulty_Level", null, t =>
                        {
                            t.HasCheckConstraint("CHK_Difficulty_Range", "Difficulty >= 1 AND Difficulty <= 6");
                        });
                });

            modelBuilder.Entity("DomainData.Models.File", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("DomainData.Models.Friend", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("DomainData.Models.Module", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("DomainData.Models.RefreshToken", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("DomainData.Models.Role", b =>
                {
                    b.Property<int>("Id")
                        .HasColumnType("int")
                        .HasColumnName("Id");
            ...
            modelBuilder.Entity("DomainData.Models.Word", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("DomainData.Models.RefreshToken", b =>
                {
                    b.HasOne("DomainData.Models.Client", "AssociatedClient")
                        .WithMany("RefreshTokens")
                        .HasForeignKey("AssociatedClientId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("DomainData.Models.User", "AssociatedUser")
                        .WithMany("RefreshTokens")
            ...
            modelBuilder.Entity("DomainData.Models.Word", b =>
                {
                    ...
                    b.HasOne("DomainData.Models.DifficultyLevel", "DifficultyNavigation")
                        .WithMany("Words")
                        .HasForeignKey("DifficultyId")
                        .HasConstraintName("FK_Difficulty_Difficulty_Level");

                    b.HasOne("DomainData.Models.Module", "Module")
                        .WithMany("Words")
            ...
            modelBuilder.Entity("ModuleUser", b =>
                {
                    b.HasOne("DomainData.Models.Module", null)
                        .WithMany()
                        .HasForeignKey("UserModulesId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("DomainData.Models.User", null)
                        .WithMany()
            ...
            modelBuilder.Entity("RoleUser", b =>
                {
                    b.HasOne("DomainData.Models.Role", null)
                        .WithMany()
