...
namespace DbManagerApi.Services.Abstracts
{
    ...
    {
        public abstract Task<Result<IEnumerable<ModuleResponseDTO>>> GetModulesSequenceAsync(string? propName, int? limit, int? moduleId, bool? reverse, int? wordsIncludeNumber);
